    ...
    (function initAlphaSelector() {
      ...
      function renderNoAccounts() {
        el.innerHTML = '<div class="card" style="text-align:center;padding:20px">' +
          '<div style="font-family:JetBrains Mono,monospace;font-size:11px;color:var(--muted);margin-bottom:8px">No accounts yet</div>' +
          '<a href="/app/settings" style="font-family:JetBrains Mono,monospace;font-size:11px;color:var(--red);text-decoration:none;letter-spacing:0.5px">\\u2699 Create one in Settings</a>' +
          '</div>';
      }
      ...
      function loadAccounts() {
        fetch('/api/alpha/accounts', { credentials: 'same-origin' })
          ...
          .catch(function() { renderNoAccounts(); });
      }
